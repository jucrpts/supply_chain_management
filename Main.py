...
data1=pd.read_csv('../Data/Dataset.csv',encoding='ISO-8859-1')
data=pd.concat([df,data1['Product Name']],axis=1)

# Load mappings from the uploaded JSON files
with open(r'../Data/dictionary.json', 'r') as file:
    mappings = json.load(file)

with open(r'../Data/dictionary1.json', 'r') as file:
    new_mappings = json.load(file)

 # Load mappings and model data
with open(r'../Data/dictionary2.json', 'r') as dict1:
...
def render_content(selected_tab):
    if selected_tab == "Home":
        st.markdown(
            ...
            <style>
            .stApp {
                background-image: url('https://prasmul-eli.co/uploads/Banner-Article-NWDSGN-SCM.jpg');
        ...
        with tab1:
            ...
            # {'Standard Class': 1, 'First Class': 2, 'Second Class': 3, 'Same Day': 4}
        ...
        with tab2:
            ...
            fig = go.Figure(data=go.Heatmap(
                ...
                colorscale='Cividis',    ### Plasma   ## Magma ### Cividis
    ...
    elif selected_tab == "Jarvis":
        st.header("Jarvis")
        st.write("This is the Jarvis (Supply Chain Management Bot).")
        queries_page()
...
with st.sidebar:
    tab = option_menu(
        ...
        ["Home", "DashBoard", "Prediction", "Jarvis"],  # Options
